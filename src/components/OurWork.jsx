...
const OurWork = () => {
    ...
    const workData = [
        {
            ...
            description: 'We turn bold odeas into powerfull digital solutions that connect, engage...',
    ...
    return (
        <motion.div
            ...
            <Title title='Our latest work' desc='From startegy to execution, we craft digital solutions that move your business forword.' />
