...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "9df0c34c-8776-4e22-b27b-ff1ae3259c27");
        ...
        <motion.div
            ...
            <motion.form
                ...
                <div className='sm:col-span-2'>
                    ...
                    <textarea name="message" rows={8} placeholder='Enter Your message' className='w-full p-3 text-sm rounded-lg border border-gray-300 dar:border-gray-600 outline-none' required />
                </div>

                <button type="submit" className='w-max flex gap-2 bg-primary text-white text-sm px-10 p-3 rounded-full cursor-pointer hover:scale-103 transition-all'>
